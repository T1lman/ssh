...
public class ProtocolHandler {
    ...
    public void sendMessage(Message message) throws IOException {
        ...
        boolean isKeyExchange = message.getType() == ssh.model.protocol.MessageType.KEY_EXCHANGE_INIT || message.getType() == ssh.model.protocol.MessageType.KEY_EXCHANGE_REPLY;
    ...
    public Message receiveMessage() throws IOException {
        if (hmacKey == null) {
            ...
            ssh.model.protocol.MessageType type = ssh.model.protocol.MessageType.fromValue(typeByte);
            if (type == ssh.model.protocol.MessageType.KEY_EXCHANGE_INIT || type == ssh.model.protocol.MessageType.KEY_EXCHANGE_REPLY) {
                ...
                return ssh.model.protocol.Message.fromPacket(fullPacketBytes, null);
            } else {
        ...
        try {
            ...
            ssh.model.protocol.MessageType messageType = ssh.model.protocol.MessageType.fromValue(typeByte);
            Message message = Message.fromPacket(fullPacketBytes, (messageType == ssh.model.protocol.MessageType.KEY_EXCHANGE_INIT || messageType == ssh.model.protocol.MessageType.KEY_EXCHANGE_REPLY) ? null : hmacKey);
