...
public class FileTransferDialog {
    ...
    public FileTransferDialog(Stage primaryStage, Consumer<File> onFileUploadRequested, Consumer<String> onFileDownloadRequested) {
    ...
    private void performFileUpload(Dialog<ButtonType> dialog, File selectedFile, String remotePath) {
        ...
        new Thread(() -> {
            try {
                ...
                onFileUploadRequested.accept(selectedFile);
                Platform.runLater(() -> {
