...
public class DeleteVerifiedUser {
    ...
    /**
     * Delete a verified user with all necessary data and optionally reload server.
     */
    public static void deleteUser(String username, ssh.client.SSHClient client) throws Exception {
        System.out.println("Deleting verified user: " + username);
        ...
        if (client != null) {
            ...
            try {
                ...
                System.out.println("  ⚠ You may need to restart the server for changes to take effect");
            }
        }
        
        // 6. Validate the deletion
